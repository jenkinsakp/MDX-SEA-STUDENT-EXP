...
<div class="container-fluid">
    ...
    <div class="row">
      ...
      @endphp
        @if($roles[0]->role=='admin'||$roles[0]->role=='resturant')
      <!-- Category -->
...
@if($roles[0]->role=='admin'||$roles[0]->role=='staff')
      <!--Posts-->
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Forum Post</div>
                      ...
                      yAxes: [{
                        ticks: {
                          ...
                          callback: function(value, index, values) {
                            return 'MUR ' + number_format(value);
                          }
                        },
                        gridLines: {
                    ...
                    tooltips: {
                      ...
                      callbacks: {
                        label: function(tooltipItem, chart) {
                          ...
                          return datasetLabel + ': MUR ' + number_format(tooltipItem.yLabel);
                        }
                      }
                    }
                  }
