            ...
            @foreach($users as $user)   
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route('user.location',$user->id)}}" class="btn btn-secondary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-map"></i></a>
