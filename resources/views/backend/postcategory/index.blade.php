        ...
        <table class="table table-bordered" id="post-category-dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            @foreach($postCategories as $data)   
                <tr>
                    <td>{{$data->id}}</td>
                    <td><button class="btn  btn-sm dltBtn" style="height:30px; width:30px;border-radius:50%; color:{{$data->color}}" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-circle"></i></button>{{$data->name}}</td>
